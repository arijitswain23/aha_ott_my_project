...
urlpatterns = [
    ...
    path('movie1/',movie1,name='movie1'),
    path('movie2/',movie2,name='movie2'),
    path('movie3/',movie3,name='movie3'),
    path('movie4/',movie4,name='movie4'),
    path('movie5/',movie5,name='movie5'),
